...
<form method="POST" action="{{ site.staticman_url }}" onsubmit="return buttonPress();">
  ...
  <label>Message:<br><textarea style="width:100%" name="fields[message]" id="comment" rows="12"></textarea></label>
...
<!--
  <form method="POST" action="{{ site.staticman_url }}" onsubmit="return buttonPress();">
    ...
    <input name="options[slug]" type="hidden" value="{{ page.slug }}">
      ...
      <label>Message</label>
      <textarea style="width:100%" name="fields[message]" id="comment" rows="12"></textarea>
